...
class Video extends Vk
{
    ...
    public function attributes()
    {
        return array_merge([
            ...
            /*v4.104*/
            'vid', 'owner_id', 'title', 'description', 'duration', 'link', 'image', 'image_medium', 'date', 'player', 'access_key', 'views',
            /** get scenario */
    ...
    public function scenarios()
    {
        ...
        $s = [
            ...
            /*v4.104*/
            'data' => ['vid', 'owner_id', 'title', 'description', 'duration', 'link', 'image', 'image_medium', 'date', 'player', 'access_key', 'views'],
    ...
    {
        return "<div class='embed-responsive embed-responsive-16by9'>
          <iframe class='embed-responsive-item' src='{$this->player}'></iframe>
        </div>
        ";
    }
