...
class Link extends Vk
{
    ...
    public function attributes()
    {
        return array_merge([
            ...
            /*v4.104*/
            'url', 'title', 'description', 'image_src', 'preview_page', 'preview_url',
    ...
    public function scenarios()
    {
        return [
            ...
            /*v4.104*/
            'data' => ['url', 'title', 'description', 'image_src', 'preview_page', 'preview_url',],
        ];
    }
    ...
    public function getThumbnail($v=null)
    {
